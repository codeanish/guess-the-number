    ...
    return (
        <div>
            ...
            <div className="hidden md:flex flex-row space-x-4 bg-neutral-800 opacity-75 pt-1 pb-1 px-2 py-2 text-sm rounded-md">
                    ...
                    <TextButton enabled={!props.gameActive}  isActive={props.selectedTime == 15} text="15" onClick={() => HandleTimeButtonSelected(15)}/>
                    <TextButton enabled={!props.gameActive}  isActive={props.selectedTime == 30} text="30" onClick={() => HandleTimeButtonSelected(30)}/>
                    <TextButton enabled={!props.gameActive}  isActive={props.selectedTime == 60} text="60" onClick={() => HandleTimeButtonSelected(60)}/>
                    <TextButton enabled={!props.gameActive}  isActive={props.selectedTime == 120} text="120" onClick={() => HandleTimeButtonSelected(120)}/>
            </div>

            {/* Mobile Configurator Bar */}
